...
# JWT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE3MDEyNzU5OTYsImlhdCI6MTcwMTI3MDU5Niwic3ViIjoiYzQ2YTA0NTctNDFkOC00ZWM1LWI5Y2QtNzg3MWM0MzQwYjg4IiwiYWRtaW4iOmZhbHNlfQ.NxHaRN9RTdBij-TtnuOMFrlnmTE0kJx0p_JJDymKSzI"

#web
API_URL = "https://codegreen.world/api/v1/data/forecast/timeshift"
JWT_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpYXQiOjE3MDA1NjkzMzMsInN1YiI6ImUwZjk5M2E4LTY0ODQtNDM4Zi1iYWM3LWI5ZDZmMDI1ODgxZiIsInNjb3BlIjoiZmlyc3QifQ.1epm3EF_jjMw25S_TijK_0X6Mab5s-7_jE2tsz6Or-k"
...
def run_tests(area_code):
    ...
    test_cases = [
        ...
        (20, 2, 30, timedelta(hours=2), "Runtime longer than hard finish time (should test if API handles this correctly)"),
...
countries_to_test =  ['DE', 'BE', 'BG', 'HR', 'CY', 'CZ', 'DK', 'EE', 'FI', 'FR', 'AT', 'GR', 'HU', 'IE', 'IT', 'LV', 'LT', 'LU', 'MT', 'NL', 'PL', 'PT', 'RO', 'SK', 'SI', 'ES', 'SE', 'CH']
