...
API_URL = "https://codegreen.world/api/v1/data/forecast/locationshift"
...
def get_hard_finish_time(additional_time):
    return (datetime.now() + additional_time).timestamp()
...
def run_tests():
    ...
    (50, 1, 30, timedelta(hours=1), "Valid runtime with multiple country-postcode combinations", [('DE', '10115'), ('BE', '1000')]),
]
